...
public class Daily extends AppCompatActivity {
    ...
    String[] subjects = {
            "Wake Up", "Take a Bath", "Have a Breakfast", "Studying", "Watching an Anime",
            "Exercising", "Sleep"
    };
    int[] subjectImage ={
            R.drawable.ic_bangun,R.drawable.ic_mandi,
            R.drawable.ic_food,R.drawable.ic_kuliah,R.drawable.ic_film,
            R.drawable.ic_basket, R.drawable.ic_tidur
    };
    String[] subjectsName = {
            "Rizan", "DulPablo", "Koi", "EL"
    };
    int[] subjectImageFriend ={
            R.drawable.rizan,R.drawable.zhildan,
            R.drawable.koi,R.drawable.el
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewAdapterFriend = new com.example.uts10120792.AdapterRecyclerViewFriend(subjectsName, subjectImageFriend,contextFriend );
