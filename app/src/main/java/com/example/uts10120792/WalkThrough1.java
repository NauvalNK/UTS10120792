...
public class WalkThrough1 extends AppCompatActivity {
    ...
    private com.example.uts10120792.OnBoardingAdapter onBoardingAdapter;
        ...
        OnBoardingAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(onBoardingViewPager.getCurrentItem() + 1 < onBoardingAdapter.getItemCount()){
                    ...
                    startActivity(new Intent(getApplicationContext(), com.example.uts10120792.HomeActivity.class));
                    finish();
                }
            }
        });
    ...
    private void setupOnBoardingItems(){
        List<com.example.uts10120792.OnBoardingItem> onBoardingItems = new ArrayList<>();
        com.example.uts10120792.OnBoardingItem item1 = new com.example.uts10120792.OnBoardingItem();
        item1.setTittle("Hi, there!");
        item1.setDescription("Welcome to My Self Apps");
        item1.setImage(R.drawable.ic_welcome);

        com.example.uts10120792.OnBoardingItem item2 = new com.example.uts10120792.OnBoardingItem();
        ...
        com.example.uts10120792.OnBoardingItem item3 = new com.example.uts10120792.OnBoardingItem();
        ...
        onBoardingAdapter = new com.example.uts10120792.OnBoardingAdapter(onBoardingItems);
    }
